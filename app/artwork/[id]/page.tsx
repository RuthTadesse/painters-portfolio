      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="absolute top-4 right-4 flex gap-2">
            ...
            <Button variant="outline" size="icon" className="bg-background/80 backdrop-blur-sm hover:bg-background/90">
        ...
        >
          <div>
            <h1 className="text-3xl md:text-4xl font-bold font-serif">{artwork.title}</h1>
            <p className="text-xl font-medium text-primary mt-2">${artwork.price}</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            {artwork.size && (
              <div className="inline-block bg-muted px-3 py-1 rounded-full text-sm ml-2">{artwork.size}</div>
            )}
          </div>
          ...
          <div className="pt-4 border-t">
            <h2 className="text-xl font-semibold mb-4">Interested in this piece?</h2>
                ...
                <Link href={`/artwork/${relatedArt.id}`} className="group">
                  <div className="relative overflow-hidden rounded-lg">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                      <h3 className="font-medium text-white">{relatedArt.title}</h3>
                      <p className="text-primary">${relatedArt.price}</p>
                    </div>
                  </div>
                </Link>
              </motion.div>
